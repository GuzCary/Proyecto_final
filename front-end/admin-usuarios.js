...
function cargarUsuarios() {
    fetch("../backend/usuarios/agregar_usuario.php")
        .then(res => res.json())
        .then(resultado => {
            if (resultado.status === "success") mostrarUsuarios(resultado.usuarios);
        });
}
...
formUsuario.addEventListener("submit", (e) => {
    ...
    fetch("../backend/usuarios/agregar_usuario.php", { method: "POST", body: datos })
        .then(res => res.json())
        .then(resultado => {
...
function eliminarUsuario(id) {
    ...
    datos.append("id", id);
    fetch("../backend/usuarios/eliminar_usuario.php", { method: "POST", body: datos })
        .then(res => res.json())
        .then(resultado => {
            if (resultado.status === "success") cargarUsuarios();
            else alert(resultado.message);
        });
}
